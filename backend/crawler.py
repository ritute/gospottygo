...
IGNOREWORDS = {} # we decided not to ignore those listed words because Google returns hits on these

class crawler(object): 
    """Crawler based on Prof. Jzhu's version"""
    def __init__(self):
    ...
    def _index_page(self, page, soup):
        ...
        if len(metas):
            ...
            for meta in metas:
                if (('name' in dict(meta.attrs)) and (meta['name'].lower() == "description")):
