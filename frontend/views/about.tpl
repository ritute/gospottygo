    ...
    <div id="container">
      ...
      <div id="main" role="main">
        ...
        <div id="about-content">
          <p>Welcome to GoSpottyGo, a teeny Google! As part of our final weekend project for CSC326 at UofT, we were required to design and develop a web application emulating a simplified version of Google's search engine. Our backend, written in Python, consists of a simple implementation of the PageRank algorithm based off of the following notes: <br/><br/>
        ...
        <br/><br/>
        We hope you enjoy! You can fork us on github <a href="https://github.com/ritute/gospottygo">here</a>!
        <br/><br/>
        Alex Litoiu<br/>
        Rita Bancewicz<br/>
        Keyi Shi
